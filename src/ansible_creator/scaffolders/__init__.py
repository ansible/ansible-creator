...
class ScaffolderBase(ABC):
    ...
    def __init__(
        ...
        self.collection_path: str = config.collection_path
        self.namespace: str = config.namespace
        self.collection_name: str = config.collection_name
        self.plugin_name: str = config.name
        self.plugin_type: str = config.type
        self.path_to_docstring: str = config.docstring
