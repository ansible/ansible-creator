...
| `EE_IMAGE_NAME` | `<repo-name>` | Image name |
...
- **Pull Request**: Builds and tests the EE, pushes to registry with `pr-<number>` tag
- **Push to main**: Builds and pushes with `latest` and commit SHA tags
